      ...
      <div className="bg-white rounded-3xl border border-emerald-50 shadow-xl shadow-emerald-100/20 overflow-hidden">
        {loading ? (
          <div className="flex flex-col items-center justify-center p-24 gap-4">
            ...
            <p className="text-indigo-400 font-bold animate-pulse">
              Cargando bitácora...
            </p>
          </div>
        ) : (
            ...
            <Column
              ...
              body={(row) => (
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-[10px] text-gray-400 font-medium px-2 py-0.5 bg-gray-100 rounded-full w-fit">
                    ...
                    {row.stay.extra_mattress_count > 0 && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-700 font-medium">
                          $
                          {(
                            row.stay.extra_mattress_unit_price || 0
                          ).toLocaleString()}
                        </span>
                      </div>
                    )}
