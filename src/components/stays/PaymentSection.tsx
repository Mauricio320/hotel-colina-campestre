    ...
    <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
      <div className="flex items-center gap-2 mb-5">
        <div className="w-8 h-8 rounded-lg bg-emerald-100 flex items-center justify-center">
          <i className="pi pi-credit-card text-emerald-600 text-sm"></i>
        </div>
        ...
        <div className="bg-[#f5f2eb] rounded-xl p-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex items-center gap-1.5 bg-white px-2.5 py-1 rounded-full border border-gray-200">
              ...
              <span className="text-xs font-semibold text-gray-700">{nights} noche{nights > 1 ? "s" : ""}</span>
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex justify-between items-center text-sm">
              <span className="text-gray-600">
                Hospedaje <span className="text-gray-400">(${priceInfo.rate.toLocaleString()})</span>
              </span>
              <span className="font-medium text-gray-800">
            ...
            {extraMattressCount > 0 && (
              <div className="flex justify-between items-center text-sm">
                <span className="text-gray-600">
                  Colchonetas <span className="text-gray-400">(${settings.mat.toLocaleString()})</span>
                </span>
                <span className="font-medium text-gray-800">
                  ${mattressTotal.toLocaleString()}
                </span>
              </div>
            )}
            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <span className={`font-medium ${priceInfo.discountAmount && priceInfo.discountAmount > 0 ? "text-red-600" : "text-gray-800"}`}>
            ...
            <div className="bg-gray-50 rounded-lg p-3 mt-auto">
              <div className="flex justify-between items-center text-sm">
                ...
                <span className={`font-bold ${
                  (watch("paid_amount") || 0) >= priceInfo.total ? "text-emerald-600" : "text-amber-600"
                }`}>
