...
const toolboxItems: ToolboxItem[] = [
  {
    name: "Contenedor",
    icon: "pi pi-th-large",
    createComponent: () => <Element is={Container} canvas background="#ffffff" padding={20} />,
  },
  {
    name: "Texto",
    icon: "pi pi-font",
    createComponent: () => <Text text="Texto de ejemplo" tag="p" />,
  },
  {
    name: "Imagen",
    icon: "pi pi-image",
    createComponent: () => (
      <Image src="https://placehold.co/600x400/e2e8f0/475569?text=Imagen" alt="Imagen" />
    ),
  },
  { name: "Hero", icon: "pi pi-star", createComponent: () => <Hero title="Título Hero" /> },
  {
    name: "Tarjetas",
    icon: "pi pi-id-card",
    createComponent: () => <Cards columns={3} cards={[]} />,
  },
  {
    name: "Galería",
    icon: "pi pi-images",
    createComponent: () => <Gallery columns={3} images={[]} />,
  },
  {
    name: "Botón",
    icon: "pi pi-play",
    createComponent: () => <Button text="Click aquí" variant="primary" />,
  },
  ...
  { name: "Video", icon: "pi pi-video", createComponent: () => <Video url="" type="youtube" /> },
  {
    name: "Formulario",
    icon: "pi pi-envelope",
    createComponent: () => <Form fields={[]} submitText="Enviar" />,
  },
  {
    name: "Newsletter",
    icon: "pi pi-send",
    createComponent: () => <Newsletter title="Suscríbete" buttonText="Suscribirse" />,
  },
];
