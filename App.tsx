...
import RegisterAdmin from './modules/auth/RegisterAdmin';
import Dashboard from './modules/dashboard/Dashboard';
import CalendarView from './modules/calendar/CalendarView';
import CheckInPage from './modules/stays/CheckInPage';
import BookingPage from './modules/stays/BookingPage';
import CheckOutPage from './modules/stays/CheckOutPage';
import RoomManagement from './modules/rooms/RoomManagement';
import GuestManagement from './modules/guests/GuestManagement';
import EmployeeManagement from './modules/employees/EmployeeManagement';
import CleaningLogs from './modules/logs/CleaningLogs';
import MaintenanceLogs from './modules/logs/MaintenanceLogs';
import Settings from './modules/settings/Settings';
import MyProfile from './modules/profile/MyProfile';
import Reports from './modules/reports/Reports';
import BookingMovements from './modules/bookings/BookingMovements';
import RoomPayments from './modules/payments/RoomPayments';
import InvoiceDetailPage from './modules/payments/InvoiceDetailPage';
...
const AppContent: React.FC = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-indigo-900">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-white font-bold animate-pulse">Iniciando sesión segura...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-indigo-900 p-4">
        <div className="bg-white p-8 rounded-2xl shadow-2xl max-w-lg w-full text-center">
          ...
          <h2 className="text-2xl font-black text-gray-800 mb-2">Base de datos no configurada</h2>
          <p className="text-gray-600 mb-6">
            No se encontró la tabla de empleados. Por favor, asegúrate de haber ejecutado el contenido del archivo <b>database.sql</b> en el editor SQL de tu proyecto Supabase.
          </p>
          <div className="p-4 bg-amber-50 rounded-lg text-amber-800 text-sm border border-amber-200 mb-6 text-left">
            <ol className="list-decimal ml-4 flex flex-col gap-2 font-medium">
              <li>Ve a tu proyecto en <b>supabase.com</b></li>
              <li>Haz clic en <b>SQL Editor</b></li>
              <li>Pega el contenido del archivo <b>database.sql</b></li>
  ...
  return (
    <Routes>
      ...
      {/* Protected Routes */}
      <Route element={user ? <Layout userRole={roleName} onLogout={logout} /> : <Navigate to="/login" />}>
