...
Self-Documenting Code Rule: Code must be clear and self-explanatory through descriptive naming and proper structure. Do not add comments—if code requires explanation, refactor it to be more readable.
